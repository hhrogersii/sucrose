...
.PHONY: examples clean-js clean-css list set-config
...
dependencies: clean-dependencies
	cp ./node_modules/d3v4/build/d3v4.js ./build/d3v4.js
	cp ./node_modules/d3v4/build/d3v4.min.js ./build/d3v4.min.js
...
TAR = scr
scr: scr sucrose.min.js
scr: TAR = scr
sgr: sgr sucrose.min.js
sgr: TAR = sgr
